...
function make() {
  var local = 100;
  return function(x) {
    local *= 2; //update global variable
    return x + local + outer; //fun = x+local+outer
  }
}
...
console.log(action(8)); //1208 local = 200
console.log(action(8)); //1408 local = 400
console.log(action(8)); //1808 local = 800
