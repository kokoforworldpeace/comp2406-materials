...
http.createServer(function(request, response) {
  ...
  request.on('end', function() {
    ...
    if (request.method == "POST") {
      let dataObj = JSON.parse(receivedData) //PARSE DATA AS JSON STRING
      ...
      //WITH THE RECEIVED "text" PROPERTY
      ...
      response.end(JSON.stringify(returnObj)) //send JSON object string
    }
