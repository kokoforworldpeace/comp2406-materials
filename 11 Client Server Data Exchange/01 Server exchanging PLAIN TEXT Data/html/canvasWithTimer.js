...
Notice in the .html source file there are no pre-attached javascript handlers.
*/
...
words.push({word: "sparkling", x: 300, y: 5})
...
function handleKeyUp(e) {
  ...
  $.post("positionData", {  //positionData url path  request
      x: movingBox.x,
      y: movingBox.y
    },
