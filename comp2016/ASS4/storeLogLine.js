...
//     'http://people.scs.carleton.ca/~ldnel/2406fall2018/tutorials/tutorial%2008/Tutorial%2008%20Using%20MongoDB%20with%20NodeJS.html'
// })
...
function search(_outputFile, _maxcount, _service, _message) {
    ...
    let find  = database.find({
        $or:[{ service: { $regex: `${_service}`, $options: "i" }}, 
        {message: { $regex: `${_message}`, $options: "i" }},
    ]})
